...
def _resolve_active_context_length() -> int:
    ...
    try:
        ...
        # Honor explicit `model.context_length` in config.yaml first. This
        # short-circuits provider probes inside get_model_context_length(), while
        # non-overridden configs still receive the active runtime provider/base
        # URL so provider-specific maximum windows can govern tool-search.
