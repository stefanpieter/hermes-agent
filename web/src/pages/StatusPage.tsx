...
export default function StatusPage() {
  ...
  return (
    <div className="flex flex-col gap-4 sm:gap-5">
      <Toast toast={toast} />
      {alerts.length > 0 && (
        <PageBand tone="contrast" innerClassName="py-4 sm:py-5 px-3 sm:px-6">
      ...
      <PageBand tone="muted" innerClassName="grid gap-4 px-3 sm:px-6 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Card className="min-w-0 overflow-hidden">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <CardTitle className="text-sm font-medium">{t.status.actions}</CardTitle>
      ...
      {platforms.length > 0 && (
        <PageBand innerClassName="px-3 sm:px-6">
          ...
          <Card>
            ...
            <CardContent className="grid gap-3">
              {activeSessions.map((s) => (
                <div
                  key={s.id}
                  className="flex w-full flex-col gap-2 border border-border bg-background/35 p-3 sm:flex-row sm:items-center sm:justify-between"
                >
      ...
      {recentSessions.length > 0 && (
        <PageBand tone="contrast" innerClassName="px-3 sm:px-6">
          <Card>
            <CardHeader>
              <div className="flex items-center gap-2">
